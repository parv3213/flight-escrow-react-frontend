...
const useStyles = makeStyles((theme) => ({ container: { display: 'flex', flexWrap: 'wrap', width: "100"}, textField: { marginLeft: theme.spacing(1), marginRight: theme.spacing(1), width: 250, }, }));
            ...
            <form onSubmit={addNewFlight}>
                <div className="form-inline">
                    ...
                    <div className="input-group mb-3 mr-3">
                        ...
                        <input type="text" list="arrival" placeholder="Mumbai" value={arrival} onChange={(e) => {setArrival(e.target.value); setSearchCity(e.target.value); searchAirport()}} required />
                        <datalist id="arrival">
                            {searchResults.map((searchResult, index) => {
                                return (<option key={index} value={searchResult}/>)
                            })}
                    ...
                    <div className="input-group mb-3 mr-3">
                        ...
                        <input type="number" placeholder="0" value={baseFare} onChange={(e) => setBaseFare(e.target.value)} required />
                    ...
                    <div className="input-group mb-3 mr-3">
                        ...
                        <input type="number" placeholder="0" value={passengerLimit} onChange={(e) => setPassengerLimit(e.target.value)} required />
                    </div>
